...
class TrainingPipelineConfig:
    ...
    def __init__(self,timestamp=datetime.now()):
        ...
        self.previous_data_dir:str = training_pipeline.PREV_DATA_DIR_NAME
        self.new_data_path: str = training_pipeline.NEW_DATA_PATH
        self.new_data_dir: str = training_pipeline.NEW_DATA_DIR

class DataIngestionConfig:
        def __init__(self,training_pipeline_config:TrainingPipelineConfig):
            self.previous_data_dir: str = training_pipeline_config.previous_data_dir
            self.new_data_path: str = training_pipeline_config.new_data_path
            self.new_data_dir: str = training_pipeline_config.new_data_dir
